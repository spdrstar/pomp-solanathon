...
import { DecodedApproveInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/approve';
import { DecodedApproveCheckedInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/approveChecked';
import { DecodedBurnInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/burn';
import { DecodedBurnCheckedInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/burnChecked';
import { DecodedCloseAccountInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/closeAccount';
import { DecodedFreezeAccountInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/freezeAccount';
import { DecodedInitializeAccountInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/initializeAccount';
import { DecodedInitializeMintInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/initializeMint';
import { DecodedInitializeMultisigInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/initializeMultisig';
import { DecodedMintToInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/mintTo';
import { DecodedMintToCheckedInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/mintToChecked';
import { DecodedRevokeInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/revoke';
import { DecodedSetAuthorityInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/setAuthority';
import { DecodedSyncNativeInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/syncNative';
import { DecodedThawAccountInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/thawAccount';
import { DecodedTransferInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/transfer';
import { DecodedTransferCheckedInstruction } from '@thirdweb-dev/sdk/node_modules/@solana/spl-token/lib/types/instructions/transferChecked';
/** TODO: docs */
