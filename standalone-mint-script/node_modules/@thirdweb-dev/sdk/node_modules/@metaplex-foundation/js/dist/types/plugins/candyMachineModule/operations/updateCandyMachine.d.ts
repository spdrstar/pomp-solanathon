...
import { Option, TransactionBuilder } from '@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/utils';
...
import { CandyMachine, CandyMachineConfigs } from '@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/plugins/candyMachineModule/models/CandyMachine';
declare const Key: "UpdateCandyMachineOperation";
/**
 * @group Operations
 * @category Constructors
 */
export declare const updateCandyMachineOperation: import("@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/types").OperationConstructor<UpdateCandyMachineOperation, "UpdateCandyMachineOperation", UpdateCandyMachineInput, UpdateCandyMachineOutput>;
/**
 * @group Operations
 * @category Types
 */
