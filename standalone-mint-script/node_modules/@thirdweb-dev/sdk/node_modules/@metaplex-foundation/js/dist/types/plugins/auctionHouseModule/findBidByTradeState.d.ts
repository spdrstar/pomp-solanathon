...
import { AuctionHouse } from '@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/plugins/auctionHouseModule/AuctionHouse';
import { Bid } from '@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/plugins/auctionHouseModule/Bid';
declare const Key: "FindBidByTradeStateOperation";
/**
 * @group Operations
 * @category Constructors
 */
export declare const findBidByTradeStateOperation: import("@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/types").OperationConstructor<FindBidByTradeStateOperation, "FindBidByTradeStateOperation", FindBidByTradeStateInput, Readonly<{
    model: "bid";
    lazy: false;
    auctionHouse: AuctionHouse;
    tradeStateAddress: import("@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/types").Pda;
    buyerAddress: PublicKey;
    bookkeeperAddress: import("@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/utils").Option<PublicKey>;
    ...
    purchaseReceiptAddress: import("@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/utils").Option<PublicKey>;
    ...
    isPublic: false;
    asset: import("@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/plugins").SftWithToken | import("@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/plugins").NftWithToken;
}> | Readonly<{
    model: "bid";
    lazy: false;
    auctionHouse: AuctionHouse;
    ...
    isPublic: true;
    asset: import("@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/plugins").Sft | import("@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/plugins").Nft;
}>>;
/**
 * @group Operations
 * @category Types
