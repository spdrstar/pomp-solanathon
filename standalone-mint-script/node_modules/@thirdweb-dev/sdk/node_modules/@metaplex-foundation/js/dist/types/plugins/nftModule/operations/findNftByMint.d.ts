...
import { Nft, NftWithToken, Sft, SftWithToken } from '@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/plugins/nftModule/models';
declare const Key: "FindNftByMintOperation";
/**
 * @group Operations
 * @category Constructors
 */
export declare const findNftByMintOperation: import("@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/types").OperationConstructor<FindNftByMintOperation, "FindNftByMintOperation", FindNftByMintInput, Sft | SftWithToken | Nft | NftWithToken>;
/**
 * @group Operations
 * @category Types
 */
