...
import { BigNumber, Operation, OperationHandler, Signer } from '@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/types';
...
import { NftWithToken } from '@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/plugins/nftModule/models';
declare const Key: "PrintNewEditionOperation";
/**
 * @group Operations
 * @category Constructors
 */
export declare const printNewEditionOperation: import("@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/types").OperationConstructor<PrintNewEditionOperation, "PrintNewEditionOperation", PrintNewEditionInput, PrintNewEditionOutput>;
/**
 * @group Operations
 * @category Types
 */
