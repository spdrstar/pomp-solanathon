...
import { Operation, OperationHandler, Signer } from '@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/types';
import { TransactionBuilder } from '@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/utils';
import { ConfirmOptions, PublicKey } from '@solana/web3.js';
import { NftWithToken } from '@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/plugins/nftModule';
...
import { CandyMachine } from '@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/plugins/candyMachineModule/models/CandyMachine';
declare const Key: "MintCandyMachineOperation";
/**
 * @group Operations
 * @category Constructors
 */
export declare const mintCandyMachineOperation: import("@thirdweb-dev/sdk/node_modules/@metaplex-foundation/js/dist/types/types").OperationConstructor<MintCandyMachineOperation, "MintCandyMachineOperation", MintCandyMachineInput, MintCandyMachineOutput>;
/**
 * @group Operations
 * @category Types
 */
