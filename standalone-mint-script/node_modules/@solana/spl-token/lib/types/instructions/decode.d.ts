...
import type { DecodedAmountToUiAmountInstruction } from '@solana/spl-token/src/instructions/amountToUiAmount.js';
import type { DecodedApproveInstruction } from '@solana/spl-token/src/instructions/approve.js';
import type { DecodedApproveCheckedInstruction } from '@solana/spl-token/src/instructions/approveChecked.js';
import type { DecodedBurnInstruction } from '@solana/spl-token/src/instructions/burn.js';
import type { DecodedBurnCheckedInstruction } from '@solana/spl-token/src/instructions/burnChecked.js';
import type { DecodedCloseAccountInstruction } from '@solana/spl-token/src/instructions/closeAccount.js';
import type { DecodedFreezeAccountInstruction } from '@solana/spl-token/src/instructions/freezeAccount.js';
import type { DecodedInitializeAccountInstruction } from '@solana/spl-token/src/instructions/initializeAccount.js';
import type { DecodedInitializeAccount2Instruction } from '@solana/spl-token/src/instructions/initializeAccount2.js';
import type { DecodedInitializeAccount3Instruction } from '@solana/spl-token/src/instructions/initializeAccount3.js';
import type { DecodedInitializeMintInstruction } from '@solana/spl-token/src/instructions/initializeMint.js';
import type { DecodedInitializeMint2Instruction } from '@solana/spl-token/src/instructions/initializeMint2.js';
import type { DecodedInitializeMultisigInstruction } from '@solana/spl-token/src/instructions/initializeMultisig.js';
import type { DecodedMintToInstruction } from '@solana/spl-token/src/instructions/mintTo.js';
import type { DecodedMintToCheckedInstruction } from '@solana/spl-token/src/instructions/mintToChecked.js';
import type { DecodedRevokeInstruction } from '@solana/spl-token/src/instructions/revoke.js';
import type { DecodedSetAuthorityInstruction } from '@solana/spl-token/src/instructions/setAuthority.js';
import type { DecodedSyncNativeInstruction } from '@solana/spl-token/src/instructions/syncNative.js';
import type { DecodedThawAccountInstruction } from '@solana/spl-token/src/instructions/thawAccount.js';
import type { DecodedTransferInstruction } from '@solana/spl-token/src/instructions/transfer.js';
import type { DecodedTransferCheckedInstruction } from '@solana/spl-token/src/instructions/transferChecked.js';
import type { DecodedUiAmountToAmountInstruction } from '@solana/spl-token/src/instructions/uiAmountToAmount.js';
/** TODO: docs */
