 ...
 */
export declare type MapsExports = keyof Omit<typeof import('@metaplex-foundation/beet-solana/node_modules/@metaplex-foundation/beet/dist/types/src/beets/maps'), 'mapsTypeMap'>;
/**
 * @category TypeDefinition
 */
