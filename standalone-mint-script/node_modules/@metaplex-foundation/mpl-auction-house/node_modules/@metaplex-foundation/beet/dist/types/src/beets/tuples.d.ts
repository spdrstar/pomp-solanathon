import { FixableBeet, FixedSizeBeet, SupportedTypeDefinition } from '@metaplex-foundation/mpl-auction-house/node_modules/@metaplex-foundation/beet/dist/types/src/types';
/**
 ...
 */
export declare type TuplesExports = keyof Omit<typeof import('@metaplex-foundation/mpl-auction-house/node_modules/@metaplex-foundation/beet/dist/types/src/beets/tuples'), 'tuplesTypeMap'>;
/**
 * @category TypeDefinition
 */
