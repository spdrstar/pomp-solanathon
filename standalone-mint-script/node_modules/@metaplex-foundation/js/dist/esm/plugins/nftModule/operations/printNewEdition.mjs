...
const printNewEditionBuilder = async (metaplex, params, options = {}) => {
  ...
  const originalTokenAccount = (_params$originalToken2 = params.originalTokenAccount) !== null && _params$originalToken2 !== void 0 ? _params$originalToken2 : metaplex.tokens().pdas().associatedTokenAccount({
    mint: originalMint,
