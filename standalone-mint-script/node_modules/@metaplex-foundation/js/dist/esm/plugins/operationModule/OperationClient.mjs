...
class OperationClient {
  ...
  async execute(operation, options = {}) {
    ...
    const signal = (_options$signal = options.signal) !== null && _options$signal !== void 0 ? _options$signal : new AbortController().signal;
  ...
  getOperationScope(options, scope) {
    ...
    const payer = (_options$payer = options.payer) !== null && _options$payer !== void 0 ? _options$payer : this.metaplex.rpc().getDefaultFeePayer();
    return { ...options,
      ...scope,
      payer
    };
