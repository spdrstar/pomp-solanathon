...
const mintCandyMachineV2Builder = async (metaplex, params, options = {}) => {
  ...
  if (candyMachine.whitelistMintSettings) {
    ...
    const whitelistToken = (_params$whitelistToke = params.whitelistToken) !== null && _params$whitelistToke !== void 0 ? _params$whitelistToke : metaplex.tokens().pdas().associatedTokenAccount({
  ...
  if (candyMachine.tokenMintAddress) {
    ...
    const payerToken = (_params$payerToken = params.payerToken) !== null && _params$payerToken !== void 0 ? _params$payerToken : metaplex.tokens().pdas().associatedTokenAccount({
...
export { mintCandyMachineV2Builder, mintCandyMachineV2Operation, mintCandyMachineV2OperationHandler };
//# sourceMappingURL=mintCandyMachineV2.mjs.map
