import { createAssociatedTokenAccountInstruction, ACCOUNT_SIZE, createInitializeAccountInstruction } from '@solana/spl-token';
...
const createTokenIfMissingBuilder = async (metaplex, params, options = {}) => {
  ...
  const destination = token !== null && token !== void 0 ? token : metaplex.tokens().pdas().associatedTokenAccount({
    mint,
    owner,
    programs
  });
