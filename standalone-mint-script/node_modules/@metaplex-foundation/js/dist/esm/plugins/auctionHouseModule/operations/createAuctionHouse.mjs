...
const createAuctionHouseBuilder = (metaplex, params, options = {}) => {
  var _params$canChangeSale, _params$requiresSignO, _params$authority, _params$treasuryMint, _params$treasuryWithd, _params$feeWithdrawal, _params$instructionKe;
