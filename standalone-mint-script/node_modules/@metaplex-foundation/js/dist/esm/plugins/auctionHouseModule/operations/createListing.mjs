...
const createListingBuilder = (metaplex, params, options = {}) => {
  ...
  const tokenAccount = (_params$tokenAccount = params.tokenAccount) !== null && _params$tokenAccount !== void 0 ? _params$tokenAccount : metaplex.tokens().pdas().associatedTokenAccount({
    mint: mintAccount,
