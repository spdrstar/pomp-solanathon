...
class AuctionHouseClient {
  ...
  findBidsBy(input, options) {
    return this.metaplex.operations().execute(findBidsByPublicKeyFieldOperation(input), options);
  }
  ...
  findListingsBy(input, options) {
    return this.metaplex.operations().execute(findListingsByPublicKeyFieldOperation(input), options);
  }
  ...
  findPurchasesBy(input, options) {
    return this.metaplex.operations().execute(findPurchasesByPublicKeyFieldOperation(input), options);
  }
