...
const tokenPaymentGuardManifest = {
  name: 'tokenPayment',
  settingsBytes: 72,
  settingsSerializer: mapSerializer(createSerializerFromBeet(tokenPaymentBeet), settings => ({ ...settings,
...
export { tokenPaymentGuardManifest };
//# sourceMappingURL=tokenPayment.mjs.map
