...
const wrapCandyGuardBuilder = (metaplex, params, options = {}) => {
  ...
  return TransactionBuilder.make().setFeePayer(payer).add({
    ...
    key: (_params$wrapCandyGuar = params.wrapCandyGuardInstructionKey) !== null && _params$wrapCandyGuar !== void 0 ? _params$wrapCandyGuar : 'wrapCandyGuard'
  });
};

export { wrapCandyGuardBuilder, wrapCandyGuardOperation, wrapCandyGuardOperationHandler };
//# sourceMappingURL=wrapCandyGuard.mjs.map
