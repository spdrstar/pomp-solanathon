...
const gatekeeperGuardManifest = {
  name: 'gatekeeper',
  settingsBytes: 33,
  settingsSerializer: mapSerializer(createSerializerFromBeet(gatekeeperBeet), settings => ({ ...settings,
  ...
  mintSettingsParser: ({
    ...
    const tokenAccount = (_mintSettings$tokenAc = mintSettings === null || mintSettings === void 0 ? void 0 : mintSettings.tokenAccount) !== null && _mintSettings$tokenAc !== void 0 ? _mintSettings$tokenAc : Pda.find(gatewayProgram.address, [payer.publicKey.toBuffer(), Buffer.from('gateway'), Buffer.from([0, 0, 0, 0, 0, 0, 0, 0]), settings.network.toBuffer()]);
