...
const nftPaymentGuardManifest = {
  ...
  mintSettingsParser: ({
    ...
    const nftTokenAccount = (_mintSettings$tokenAc = mintSettings.tokenAccount) !== null && _mintSettings$tokenAc !== void 0 ? _mintSettings$tokenAc : metaplex.tokens().pdas().associatedTokenAccount({
