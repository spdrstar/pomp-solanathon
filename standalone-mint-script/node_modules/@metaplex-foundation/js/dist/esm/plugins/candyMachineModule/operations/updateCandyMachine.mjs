...
const updateCandyMachineCollectionBuilder = (metaplex, params, authority, payer, programs) => {
  ...
  const currentCollectionAddress = (_params$collection$cu = params.collection.currentCollectionAddress) !== null && _params$collection$cu !== void 0 ? _params$collection$cu : isCandyMachine(params.candyMachine) ? params.candyMachine.collectionMintAddress : null;
...
const onMissingInputError = missingKeys => new MissingInputDataError(missingKeys, {
