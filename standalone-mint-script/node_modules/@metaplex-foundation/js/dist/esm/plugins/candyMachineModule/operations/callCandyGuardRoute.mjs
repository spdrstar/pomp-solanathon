...
const callCandyGuardRouteBuilder = (metaplex, params, options = {}) => {
  ...
  .add({
    ...
    key: (_params$instructionKe = params.instructionKey) !== null && _params$instructionKe !== void 0 ? _params$instructionKe : 'callGuardRoute'
  });
};

export { callCandyGuardRouteBuilder, callCandyGuardRouteOperation, callCandyGuardRouteOperationHandler };
//# sourceMappingURL=callCandyGuardRoute.mjs.map
