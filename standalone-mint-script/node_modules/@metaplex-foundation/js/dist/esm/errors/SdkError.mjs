...
class FailedToSerializeDataError extends SdkError {
  constructor(dataDescription, options) {
    super({
      options,
      ...
      solution: 'Ensure the data is of the expected type so it can be serialized.'
    });
  }
...
class MissingInputDataError extends SdkError {
  constructor(missingParameters, options) {
    super({
      options,
      key: 'missing_input_data',
      title: 'Missing Input Data',
      problem: 'Some parameters are missing from the provided input object.',
      solution: 'Please provide the following missing parameters: [' + missingParameters.join(', ') + '].'
    });
  }
...
class FailedToDeserializeDataError extends SdkError {
  constructor(dataDescription, options) {
    super({
      ...
      solution: 'Ensure the serialized data is not corrupted and complies with the expected type.'
    });
  }
...
export { AccountNotFoundError, AssetNotFoundError, CurrencyMismatchError, DriverNotProvidedError, ExpectedSignerError, FailedToDeserializeDataError, FailedToSerializeDataError, InvalidJsonStringError, InvalidJsonVariableError, MissingGpaBuilderError, MissingInputDataError, NoInstructionsToSendError, NotYetImplementedError, OperationHandlerMissingError, OperationNotSupportedByWalletAdapterError, OperationUnauthorizedForGuestsError, ProgramNotRecognizedError, SdkError, TaskIsAlreadyRunningError, UnexpectedAccountError, UnexpectedCurrencyError, UnexpectedTypeError, UninitializedWalletAdapterError, UnreachableCaseError };
