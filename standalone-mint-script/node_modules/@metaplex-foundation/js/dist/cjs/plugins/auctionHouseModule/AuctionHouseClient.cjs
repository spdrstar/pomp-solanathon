...
class AuctionHouseClient {
  ...
  findBidsBy(input, options) {
    return this.metaplex.operations().execute(findBidsByPublicKeyField.findBidsByPublicKeyFieldOperation(input), options);
  }
  ...
  findListingsBy(input, options) {
    return this.metaplex.operations().execute(findListingsByPublicKeyField.findListingsByPublicKeyFieldOperation(input), options);
  }
  ...
  findPurchasesBy(input, options) {
    return this.metaplex.operations().execute(findPurchasesByPublicKeyField.findPurchasesByPublicKeyFieldOperation(input), options);
  }
