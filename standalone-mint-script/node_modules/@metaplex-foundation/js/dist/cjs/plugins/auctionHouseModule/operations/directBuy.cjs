...
const directBuyOperation = Operation.useOperation(Key);
/**
 * @group Operations
 * @category Types
 */
...
const directBuyBuilder = async (metaplex, params, options = {}) => {
  ...
  const printReceipt = ((_params$printReceipt = params.printReceipt) !== null && _params$printReceipt !== void 0 ? _params$printReceipt : true) && Boolean(receiptAddress);
  ...
  const purchasedAsset = { ...asset,
    token: { ...asset.token,
      ...
      ownerAddress: PublicKey.toPublicKey(buyer)
    }
  };
  const purchase = {
    auctionHouse,
    model: 'purchase',
    lazy: false,
    buyerAddress: PublicKey.toPublicKey(buyer),
    sellerAddress,
...
exports.directBuyBuilder = directBuyBuilder;
exports.directBuyOperation = directBuyOperation;
exports.directBuyOperationHandler = directBuyOperationHandler;
//# sourceMappingURL=directBuy.cjs.map
