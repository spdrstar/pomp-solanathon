...
const auctionHouseModule = () => ({
  install(metaplex) {
    ...
    const auctionHouseProgram = {
      ...
      address: mplAuctionHouse.PROGRAM_ID,
    ...
    op.register(directBuy.directBuyOperation, directBuy.directBuyOperationHandler);
    op.register(directSell.directSellOperation, directSell.directSellOperationHandler);
