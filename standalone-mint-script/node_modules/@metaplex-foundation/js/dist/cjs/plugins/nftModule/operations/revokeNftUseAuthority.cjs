...
const revokeNftUseAuthorityBuilder = (metaplex, params, options = {}) => {
  var _params$ownerTokenAdd, _params$instructionKe;
  ...
  const ownerTokenAddress = (_params$ownerTokenAdd = params.ownerTokenAddress) !== null && _params$ownerTokenAdd !== void 0 ? _params$ownerTokenAdd : metaplex.tokens().pdas().associatedTokenAccount({
    mint: mintAddress,
    owner: owner.publicKey,
    programs
  });
  return TransactionBuilder.TransactionBuilder.make().setFeePayer(payer) // Revoke the use authority.
  .add({
