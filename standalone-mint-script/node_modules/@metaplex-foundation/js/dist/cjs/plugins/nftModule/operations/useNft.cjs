...
const useNftBuilder = (metaplex, params, options = {}) => {
  ...
  const tokenAccount = (_params$ownerTokenAcc = params.ownerTokenAccount) !== null && _params$ownerTokenAcc !== void 0 ? _params$ownerTokenAcc : metaplex.tokens().pdas().associatedTokenAccount({
    mint: mintAddress,
  ...
  return TransactionBuilder.TransactionBuilder.make().setFeePayer(payer) // Update the metadata account.
  .add({
