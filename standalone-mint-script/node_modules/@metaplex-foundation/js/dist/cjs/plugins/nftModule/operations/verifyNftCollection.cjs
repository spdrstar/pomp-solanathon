...
const verifyNftCollectionBuilder = (metaplex, params, options = {}) => {
  ...
  const instruction = isSizedCollection ? mplTokenMetadata.createVerifySizedCollectionItemInstruction(accounts, tokenMetadataProgram.address) : mplTokenMetadata.createVerifyCollectionInstruction(accounts, tokenMetadataProgram.address);
