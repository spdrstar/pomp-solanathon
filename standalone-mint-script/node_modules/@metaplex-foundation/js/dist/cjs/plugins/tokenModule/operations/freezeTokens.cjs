 ...
 * @category Constructors
 */
const freezeTokensBuilder = (metaplex, params, options = {}) => {
  ...
  return TransactionBuilder.TransactionBuilder.make().setFeePayer(payer).add({
    instruction: splToken.createFreezeAccountInstruction(tokenAddressOrAta, mintAddress, authorityPublicKey, multiSigners, tokenProgram.address),
    signers,
