...
const sendTokensBuilder = async (metaplex, params, options = {}) => {
  ...
  return TransactionBuilder.TransactionBuilder.make().setFeePayer(payer) // Create token account if missing.
