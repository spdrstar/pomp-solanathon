...
const mintFromCandyMachineOperationHandler = {
  async handle(operation, metaplex, scope) {
    ...
    try {
      ...
      const activeGuards = metaplex.candyMachines().guards().resolveGroupSettings(candyGuard.guards, candyGuard.groups, (_operation$input$grou = operation.input.group) !== null && _operation$input$grou !== void 0 ? _operation$input$grou : null);
...
const mintFromCandyMachineBuilder = async (metaplex, params, options = {}) => {
  ...
  if (!!candyMachine.candyGuard) {
    ...
    const parsedMintSettings = guardClient.parseMintSettings(candyMachine.address, candyGuard, payer, guards, group, programs);
    mintNftSigners = [payer, mint, ...parsedMintSettings.signers];
    mintNftInstruction = mplCandyGuard.createMintInstruction({ ...sharedMintAccounts,
    ...
    mintNftInstruction = mplCandyMachineCore.createMintInstruction({ ...sharedMintAccounts,
      authorityPda,
  ...
  .add({
    ...
    key: (_params$mintFromCandy = params.mintFromCandyMachineInstructionKey) !== null && _params$mintFromCandy !== void 0 ? _params$mintFromCandy : 'mintNft'
  });
};
