...
const deleteCandyMachineBuilder = (metaplex, params, options = {}) => {
  ...
  const builder = TransactionBuilder.TransactionBuilder.make().setFeePayer(payer).add({
    instruction: mplCandyMachineCore.createWithdrawInstruction({
      candyMachine,
      authority: authority.publicKey
    }, candyMachineProgram.address),
    signers: [authority],
    key: (_params$deleteCandyMa = params.deleteCandyMachineInstructionKey) !== null && _params$deleteCandyMa !== void 0 ? _params$deleteCandyMa : 'deleteCandyMachine'
  });
